...
_Auto-generated 2026-07-21T23:06:30Z. 9352 candidates logged, 5524 with a filled 24h forward price._
...
| filtered out | 5176 | -0.56c | +0.00c | 47% | NOISE (no measurable edge) |
...
| large_trade | 1554 | -0.07c | +0.00c | 51% | NOISE (no measurable edge) |
| within_trader | 667 | -0.16c | -0.00c | 51% | NOISE (no measurable edge) |
| volume_spike | 4453 | -0.24c | +0.00c | 47% | NOISE (no measurable edge) |
...
| Bucket | Samples | Avg move | Median | Moved our way | Verdict |
|---|---|---|---|---|---|
| other | 2475 | -0.36c | +0.00c | 48% | NOISE (no measurable edge) |
...
| Bucket | Samples | Avg move | Median | Moved our way | Verdict |
|---|---|---|---|---|---|
| 40 to 54 | 790 | -0.18c | -0.00c | 48% | NOISE (no measurable edge) |
| under 40 | 3543 | -0.56c | -0.00c | 46% | NOISE (no measurable edge) |
...
| Bucket | Samples | Avg move | Median | Moved our way | Verdict |
|---|---|---|---|---|---|
| normal | 4510 | -0.47c | +0.00c | 47% | NOISE (no measurable edge) |
