...
| repeat_actor | 561 | -0.00c | +0.00c | 53% | NOISE (no measurable edge) |
| large_trade | 1144 | -0.05c | +0.00c | 52% | NOISE (no measurable edge) |
| within_trader | 486 | -0.07c | -0.00c | 52% | NOISE (no measurable edge) |
| price_impact | 256 | -0.18c | +0.00c | 50% | NOISE (no measurable edge) |
...
| sports | 195 | -1.94c | +0.00c | 49% | FADE (signal points the wrong way) |
...
| p_24h (alerted only) | 129 | +0.89c | 48% |
