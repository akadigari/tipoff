...
_Auto-generated 2026-07-21T15:12:59Z. 8984 candidates logged, 5257 with a filled 24h forward price._
...
| filtered out | 4920 | -0.57c | -0.00c | 47% | NOISE (no measurable edge) |
...
| repeat_actor | 759 | -0.03c | +0.00c | 51% | NOISE (no measurable edge) |
| large_trade | 1479 | -0.11c | -0.00c | 51% | NOISE (no measurable edge) |
| within_trader | 637 | -0.12c | -0.00c | 51% | NOISE (no measurable edge) |
| volume_spike | 4225 | -0.25c | +0.00c | 47% | NOISE (no measurable edge) |
...
| Bucket | Samples | Avg move | Median | Moved our way | Verdict |
|---|---|---|---|---|---|
| politics | 1740 | -0.36c | +0.00c | 44% | NOISE (no measurable edge) |
| other | 2367 | -0.36c | +0.00c | 48% | NOISE (no measurable edge) |
| crypto | 601 | -1.09c | -0.10c | 46% | FADE (signal points the wrong way) |
...
| under 40 | 3367 | -0.57c | +0.00c | 46% | NOISE (no measurable edge) |
| 55 to 69 | 660 | -0.65c | +0.00c | 48% | NOISE (no measurable edge) |
...
| Bucket | Samples | Avg move | Median | Moved our way | Verdict |
|---|---|---|---|---|---|
| normal | 4266 | -0.47c | +0.00c | 47% | NOISE (no measurable edge) |
