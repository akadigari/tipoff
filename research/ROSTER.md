...
_Auto-generated 2026-07-25T09:57:54Z. 1192 flagged wallets, 16 with enough graded trades to judge, 2 that beat a coin flip._
...
|---|---|---|---|---|---|---|---|
| `0xeb6f0a13ea...` | 14 | +2.37c | 85% | 0.01 | 6 | 17 | WATCH (beats luck) |
...
| `0xf705fa0452...` | 12 | +3.15c | 75% | 0.07 | 15 | 24 | PROMISING (edge, luck not ruled out) |
...
| `0x122cb94c43...` | 20 | +0.02c | 45% | 0.75 | 19 | 28 | NOISE (busy, not sharp) |
| `0x511f9c7714...` | 35 | -0.32c | 50% | 0.57 | 21 | 44 | NOISE (busy, not sharp) |
| `0x8b4bca1d79...` | 12 | -1.51c | 50% | 0.62 | 12 | 15 | FADE (bets the wrong way) |
| `0x6916cc00aa...` | 22 | -2.57c | 44% | 0.76 | 16 | 32 | FADE (bets the wrong way) |
