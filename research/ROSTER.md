...
_Auto-generated 2026-07-31T10:49:22Z. 1262 flagged wallets, 18 with enough graded trades to judge, 1 that beat a coin flip._
...
|---|---|---|---|---|---|---|---|
| `0xeb6f0a13ea...` | 13 | +5.70c | 100% | 0.00 | 5 | 25 | WATCH (beats luck) |
...
| `0xf705fa0452...` | 17 | -0.89c | 56% | 0.40 | 14 | 40 | NOISE (busy, not sharp) |
...
| `0x511f9c7714...` | 19 | -2.98c | 47% | 0.68 | 23 | 52 | FADE (bets the wrong way) |
| `0xa8c63f775d...` | 12 | -4.38c | 60% | 0.38 | 12 | 14 | FADE (bets the wrong way) |
| `0x06dc51826b...` | 26 | -5.01c | 50% | 0.58 | 35 | 62 | FADE (bets the wrong way) |
