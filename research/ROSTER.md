...
_Auto-generated 2026-07-24T07:39:20Z. 1198 flagged wallets, 16 with enough graded trades to judge, 1 that beat a coin flip._
...
| `0x6916cc00aa...` | 26 | -1.48c | 48% | 0.67 | 17 | 31 | FADE (bets the wrong way) |
| `0xb10047d6a2...` | 13 | -1.89c | 36% | 0.89 | 12 | 15 | FADE (bets the wrong way) |
| `0x7f9e2d1df7...` | 12 | -2.18c | 44% | 0.75 | 11 | 16 | FADE (bets the wrong way) |
| `0xe734e7bf7c...` | 20 | -2.80c | 50% | 0.59 | 10 | 28 | FADE (bets the wrong way) |
| `0xfc2f4f50ce...` | 12 | -5.56c | 42% | 0.81 | 11 | 14 | FADE (bets the wrong way) |
| `0x06dc51826b...` | 12 | -7.79c | 33% | 0.93 | 23 | 28 | FADE (bets the wrong way) |
