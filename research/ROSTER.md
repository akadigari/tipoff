...
_Auto-generated 2026-08-22T19:30:16Z. 1201 flagged wallets, 11 with enough graded trades to judge, 3 that beat a coin flip._
...
| Wallet | Graded | Avg move | Hit rate | Luck p | Markets | Flags | Verdict |
|---|---|---|---|---|---|---|---|
| `0xf705fa0452...` | 29 | +5.18c | 61% | 0.17 | 49 | 147 | PROMISING (edge, luck not ruled out) |
...
| `0x1465b79bff...` | 21 | +3.14c | 79% | 0.01 | 10 | 67 | WATCH (beats luck) |
| `0x879247bf75...` | 12 | +2.50c | 92% | 0.00 | 8 | 22 | WATCH (beats luck) |
| `0x122cb94c43...` | 28 | +0.79c | 59% | 0.22 | 30 | 120 | NOISE (busy, not sharp) |
...
| `0x06dc51826b...` | 29 | -5.38c | 59% | 0.23 | 55 | 197 | FADE (bets the wrong way) |
