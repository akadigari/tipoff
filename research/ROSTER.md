...
_Auto-generated 2026-08-25T01:46:46Z. 1200 flagged wallets, 17 with enough graded trades to judge, 1 that beat a coin flip._
...
|---|---|---|---|---|---|---|---|
| `0xf705fa0452...` | 59 | +3.98c | 63% | 0.03 | 54 | 172 | WATCH (beats luck) |

## Promising (edge, needs more data to rule out luck)

| Wallet | Graded | Avg move | Hit rate | Luck p | Markets | Flags | Verdict |
|---|---|---|---|---|---|---|---|
| `0xcc500cbcc8...` | 23 | +4.34c | 64% | 0.14 | 22 | 74 | PROMISING (edge, luck not ruled out) |
| `0xa19cbababc...` | 12 | +4.13c | 73% | 0.11 | 10 | 19 | PROMISING (edge, luck not ruled out) |
| `0x1465b79bff...` | 34 | +1.84c | 65% | 0.08 | 17 | 93 | PROMISING (edge, luck not ruled out) |
...
| `0x1465b79bff...` | 34 | +1.84c | 65% | 0.08 | 17 | 93 | PROMISING (edge, luck not ruled out) |
| `0x6d9fc316c3...` | 17 | +1.16c | 64% | 0.27 | 16 | 67 | PROMISING (edge, luck not ruled out) |
| `0x000d257d2d...` | 12 | +0.93c | 73% | 0.11 | 12 | 39 | NOISE (busy, not sharp) |
...
| `0x06dc51826b...` | 42 | -6.36c | 62% | 0.08 | 61 | 216 | FADE (bets the wrong way) |
